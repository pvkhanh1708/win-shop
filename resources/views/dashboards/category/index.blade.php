                ...
                <div class="card-header pb-0">
                    <div class="row pb-3">
                        <div class="col-md-12 col-12 text-center position-relative">
                            ...
                            <div id="add-category" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" style="display: none;" aria-hidden="true">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group fill">
                                                            ...
                                                            <input type="text" name="name" class="form-control" id="category_name" aria-describedby="Tên danh mục" placeholder="Tên danh mục">
                            ...
                            <button type="button" class="btn btn-primary btn-icon has-ripple" style="z-index: 1000; position: absolute; right: 15px; top: 0;" data-toggle="modal" data-target="#add-category"><i class="fas fa-plus"></i><span class="ripple ripple-animate" style="height: 174.078px; width: 174.078px; animation-duration: 0.7s; animation-timing-function: linear; background: rgb(255, 255, 255); opacity: 0.4; top: -66.031px; left: -0.359125px;"></span></button>
                        </div>
                    </div>
                            ...
                            <div class="d-md-flex flex-direction-row justify-content-end w-100">
                                <div class="mx-md-2 col-xs-12">
                                    <div class="d-flex flex-row align-items-center">
                                        ...
                                        <select name="sort" id="sort" data-type="category" data-content="table-content" data-route-data="{{ route('category') }}" class="sort form-control">
                                            {{-- <option value=""></option> --}}
                                            <option value="id" data-sort="asc" {{ (Session::has('sort-category')&&Session::get('sort-category')=='id'&&Session::get('sort-categories')=='asc')?'selected':'' }}>ID nhỏ -> lớn</option>
                                            <option value="id" data-sort="desc" {{ (Session::has('sort-category')&&Session::get('sort-category')=='id'&&Session::get('sort-categories')=='desc')?'selected':'' }}>ID lớn -> nhỏ</option>
                                            <option value="name" data-sort="asc" {{ (Session::has('sort-category')&&Session::get('sort-category')=='name'&&Session::get('sort-categories')=='asc')?'selected':'' }}>Tên A-Z</option>
                                            <option value="name" data-sort="desc" {{ (Session::has('sort-category')&&Session::get('sort-category')=='name'&&Session::get('sort-categories')=='desc')?'selected':'' }}>Tên Z-A</option>
                                            <option value="created_at" data-sort="asc" {{ (Session::has('sort-category')&&Session::get('sort-category')=='created_at'&&Session::get('sort-categories')=='asc')?'selected':'' }}>Cũ nhất</option>
                                            <option value="created_at" data-sort="desc" {{ (Session::has('sort-category')&&Session::get('sort-category')=='created_at'&&Session::get('sort-categories')=='desc')?'selected':'' }}>Mới nhất</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="mx-md-2 col-xs-12">
                                    <div class="d-flex flex-row align-items-center">
                                        ...
                                        <select name="limit" id="limit" data-route-data="{{ route('category') }}" class="limit form-control">
                                ...
                                <div class="mx-md-2 col-xs-12">
                                    <div class="d-flex flex-row align-items-center">
                                        ...
                                        <input type="text" value="" class="form-control search-table" data-route="{{ route('search-category') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                                                ...
                                                <tr class="view-list">
                                                    ...
                                                    <td style="white-space: normal;">
                                                        <ul class="mb-0 pl-2">
                                                            ...
                                                            <li>
                                                                Số lượng sản phẩm: <b>{{ $item->products()->count('id') }}</b>
                                                                <a href="{{ route('view-category-products', ['id'=>$item->id]) }}">Xem</a>
                                                            </li>
                                                            <li>
