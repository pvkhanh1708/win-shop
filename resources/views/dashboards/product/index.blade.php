                            ...
                            <div class="d-md-flex flex-direction-row justify-content-end w-100">
                                <div class="mx-md-2 col-xs-12">
                                    <div class="d-flex flex-row align-items-center">
                                        ...
                                        <select name="sort" id="sort" data-type="product" data-content="table-content" data-route-data="{{ route('product') }}" class="sort form-control">
                                            {{-- <option value=""></option> --}}
                                            <option value="id" data-sort="asc" {{ (Session::has('sort-product')&&Session::get('sort-product')=='id'&&Session::get('sort-products')=='asc')?'selected':'' }}>ID tăng</option>
                                            <option value="id" data-sort="desc" {{ (Session::has('sort-product')&&Session::get('sort-product')=='id'&&Session::get('sort-products')=='desc')?'selected':'' }}>ID giảm</option>
                                            <option value="name" data-sort="asc" {{ (Session::has('sort-product')&&Session::get('sort-product')=='name'&&Session::get('sort-products')=='asc')?'selected':'' }}>Tên A-Z</option>
                                            <option value="name" data-sort="desc" {{ (Session::has('sort-product')&&Session::get('sort-product')=='name'&&Session::get('sort-products')=='desc')?'selected':'' }}>Tên Z-A</option>
                                            <option value="cost_price" data-sort="asc" {{ (Session::has('sort-product')&&Session::get('sort-product')=='cost_price'&&Session::get('sort-products')=='asc')?'selected':'' }}>Giá tăng</option>
                                            <option value="cost_price" data-sort="desc" {{ (Session::has('sort-product')&&Session::get('sort-product')=='cost_price'&&Session::get('sort-products')=='desc')?'selected':'' }}>Giá giảm</option>
                                            <option value="count" data-sort="asc" {{ (Session::has('sort-product')&&Session::get('sort-product')=='count'&&Session::get('sort-products')=='asc')?'selected':'' }}>Số lượng tăng </option>
                                            <option value="count" data-sort="desc" {{ (Session::has('sort-product')&&Session::get('sort-product')=='count'&&Session::get('sort-products')=='desc')?'selected':'' }}>Số lượng giảm</option>
                                            <option value="created_at" data-sort="asc" {{ (Session::has('sort-product')&&Session::get('sort-product')=='created_at'&&Session::get('sort-products')=='asc')?'selected':'' }}>Cũ nhất</option>
                                            <option value="created_at" data-sort="desc" {{ (Session::has('sort-product')&&Session::get('sort-product')=='created_at'&&Session::get('sort-products')=='desc')?'selected':'' }}>Mới nhất</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="mx-md-2 col-xs-12">
                                    <div class="d-flex flex-row align-items-center">
                                        ...
                                        <select name="limit" id="limit" data-route-data="{{ route('product') }}" class="limit form-control">
