            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('product') }}"><i class="fas fa-archive"></i> Sản phẩm</a></li>
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <div class="form-group fill">
                                    ...
                                    <input type="text" name="name" value="{{ $product->name }}" class="form-control" id="name" aria-describedby="Tên sản phẩm" placeholder="Tên sản phẩm">
                                    <small class="form-text text-muted"></small>
                                </div>
                                <div class="form-group fill">
                                    <label for="cost_price">Giá sản phẩm</label>
                                    <input type="number" name="cost_price" value="{{ $product->cost_price }}" class="form-control" id="cost_price" aria-describedby="Giá sản phẩm" placeholder="Giá sản phẩm">
                                    <small  class="form-text text-muted">Giá mặc định</small>
                                </div>
                                <div class="form-group fill">
                                    <label for="sale_price">Giá khuyễn mãi</label>
                                    <input type="number" name="sale_price" value="{{ $product->sale_price }}" class="form-control" id="sale_price" aria-describedby="Giá khuyến mãi" placeholder="Giá khuyến mãi">
                                    <small  class="form-text text-muted">Bỏ trống nếu không dùng</small>
                                </div>
                                <div class="form-group fill">
                                    <label for="unit">Đơn vị tính</label>
                                    <input type="text" name="unit" value="{{ $product->unit }}" class="form-control" id="unit" aria-describedby="Đơn vị tính" placeholder="Đơn vị tính">
                                    <small class="form-text text-muted"></small>
                                </div>
                                <div class="form-group fill">
                                    <label for="count">Số lượng</label>
                                    <input type="number" name="count" value="{{ $product->count }}" class="form-control" id="count" aria-describedby="Số lượng" placeholder="Số lượng">
                                    <small class="form-text text-muted"></small>
                                </div>
...
{{--                                </div>--}}
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="col-12 text-center ld-over" id="image-main" >
                                    ...
                                    <button type="button" style="margin-top: -20px;" class="btn btn-icon btn-success btn-edit-image-main ld-over">
                                ...
                                <div class="row m-2">
                                    @foreach ($categories as $item)
                                        <div class="col-md-3 col-6 col-xs-6 icheck-primary d-inline">
                                            <input class="icheck" name="category_id[]" value="{{ $item->id }}" type="checkbox" id="check-{{ $item->id }}" {{ in_array($item->id,$product->categories->pluck('category_id')->toArray())?'checked':'' }}>
                        ...
                        <div class="row">
                            <div class="col-md-12 d-flex align-items-center justify-content-between">
                                <div class="float-left"><h5><b>Ảnh sản phẩm</b></h5></div>
                                        ...
                                        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                                ...
                                                                <div class="form-group fill">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="custom-file">
                                                                            <input type="file" class="custom-file-input" id="upload-image-product" accept="image/*">
                                                ...
                                                <div class="modal-footer d-flex justify-content-center p-2">
                                                    <button type="button" id="add-image" class="btn  btn-primary">Thêm</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <button type="button" class="btn btn-primary btn-icon has-ripple float-right" data-toggle="modal" data-target="#add-product"><i class="fas fa-plus"></i><span class="ripple ripple-animate" style="height: 174.078px; width: 174.078px; animation-duration: 0.7s; animation-timing-function: linear; background: rgb(255, 255, 255); opacity: 0.4; top: -66.031px; left: -0.359125px;"></span></button>
                                </div>
                            </div>
    ...
    <nav class="navbar navbar-light bg-primary navbar-bottom d-flex align-items-center">
        ...
        <div class="btn btn-light btn-submit mx-4 ld-over">Lưu<div class="ld ld-ring ld-spin"></div></div>
    </nav>
    <div id="DeleteImage" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    ...
    <div id="EditImageMain" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
