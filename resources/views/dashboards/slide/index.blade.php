                ...
                <div class="card-header pb-0">
                    <div class="row pb-3">
                        <div class="col-md-12 col-12 text-center position-relative">
                            ...
                            <div id="add-slide" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" style="display: none;" aria-hidden="true">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group fill">
                                                            ...
                                                            <input type="text" name="count" class="form-control" id="link" value="https://" aria-describedby="Link" placeholder="Link">
                            ...
                            <button type="button" class="btn btn-primary btn-icon has-ripple" style="z-index: 1000; position: absolute; right: 15px; top: 0;" data-toggle="modal" data-target="#add-slide"><i class="fas fa-plus"></i><span class="ripple ripple-animate" style="height: 174.078px; width: 174.078px; animation-duration: 0.7s; animation-timing-function: linear; background: rgb(255, 255, 255); opacity: 0.4; top: -66.031px; left: -0.359125px;"></span></button>
                        </div>
                    </div>
                            ...
                            <div class="d-md-flex flex-direction-row justify-content-end w-100">
                                <div class="mx-md-2 col-xs-12">
                                    <div class="d-flex flex-row align-items-center">
                                        ...
                                        <select name="sort" id="sort" data-type="slide" data-content="table-content" data-route-data="{{ route('slide') }}" class="sort form-control">
                                            {{-- <option value=""></option> --}}
                                            <option value="id" data-sort="asc" {{ (Session::has('sort-slide')&&Session::get('sort-slide')=='id'&&Session::get('sort-slides')=='asc')?'selected':'' }}>ID tăng</option>
                                            <option value="id" data-sort="desc" {{ (Session::has('sort-slide')&&Session::get('sort-slide')=='id'&&Session::get('sort-slides')=='desc')?'selected':'' }}>ID giảm</option>
                                            <option value="title" data-sort="asc" {{ (Session::has('sort-slide')&&Session::get('sort-slide')=='title'&&Session::get('sort-slides')=='asc')?'selected':'' }}>Tên A-Z</option>
                                            <option value="title" data-sort="desc" {{ (Session::has('sort-slide')&&Session::get('sort-slide')=='title'&&Session::get('sort-slides')=='desc')?'selected':'' }}>Tên Z-A</option>
                                            <option value="created_at" data-sort="asc" {{ (Session::has('sort-slide')&&Session::get('sort-slide')=='created_at'&&Session::get('sort-slides')=='asc')?'selected':'' }}>Cũ nhất</option>
                                            <option value="created_at" data-sort="desc" {{ (Session::has('sort-slide')&&Session::get('sort-slide')=='created_at'&&Session::get('sort-slides')=='desc')?'selected':'' }}>Mới nhất</option>
                                            <option value="status" data-sort="asc" {{ (Session::has('sort-slide')&&Session::get('sort-slide')=='status'&&Session::get('sort-slides')=='asc')?'selected':'' }}>Hoạt động</option>
                                            <option value="status" data-sort="desc" {{ (Session::has('sort-slide')&&Session::get('sort-slide')=='status'&&Session::get('sort-slides')=='desc')?'selected':'' }}>Ngừng hoạt động</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="mx-md-2 col-xs-12">
                                    <div class="d-flex flex-row align-items-center">
                                        ...
                                        <select name="limit" id="limit" data-route-data="{{ route('slide') }}" class="limit form-control">
                                ...
                                <div class="mx-md-2 col-xs-12">
                                    <div class="d-flex flex-row align-items-center">
                                        ...
                                        <input type="text" value="" class="form-control search-table" data-route="{{ route('search-product') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
