					...
					<div class="card-body">
                        <form action="{{route('dashboards-login')}}" method="post">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="email" value="{{ old('email') }}" class="form-control" id="Email" placeholder="">
                            </div>
                            ...
                            <div class="custom-control custom-checkbox text-left mb-4 mt-2">
                                <input type="checkbox" name="remember" value="{{ old('remember') }}" class="custom-control-input" id="customCheck1">
                            ...
                            <p class="mb-2 text-muted">Quên mật khẩu? <a href="auth-reset-password.html" class="f-w-400">Đặt lại</a></p>
                        </form>
                    </div>
				</div>
			</div>
