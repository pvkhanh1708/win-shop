            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="{{ route('home') }}"><img src="{{ url('images/logo.png') }}" alt="" style="max-height: 60px"></a>
                    </div>
                </div>
                <div class="col-lg-6">
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        ...
                        <div class="header__cart__price">Tổng: <span
                                class="sum__cart">0</span> {{ trans('page.currency') }}</div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="hero__search__form">
                        <form action="{{ route('search') }}">
                            <div class="hero__search__categories" style="padding: 0;">
                                <select name="" id="address-select" class="form-control w-100 border-0" style="height: 48px;">
                                    <span class="arrow_carrot-down"></span>
                            ...
                            <input type="text" placeholder="{{ trans('page.what_you_need') }}">
